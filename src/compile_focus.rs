...
pub(crate) const TARGETS: [u32; 2] = [0x021F81A0, 0x021F994C];
...
pub(crate) fn append_report(out:&mut String) {
    ...
    out.push_str("[compile_focus]\nscope=next3_ARM9_Thumb_overlay_hotspots fresh_decode_identity_no_extra_guest_reads timing_units=us stages=setup,emit,finalize,insert last_immediates_are_addresses_not_values identity_includes_cycles_not_external_data\n");
